...
// Last modified: 5/27/2016, 2:49:35 AM
...
var drawWidth = c.width, drawHeight = c.height, tileWidth = 0, tileHeight = 0, tileSize = 32, tileHalfSize = tileSize / 2, offsetX = 0, offsetY = 0, minVisTileX = 0, minVisTileY = 0, maxVisTileX = 0, maxVisTileY = 0, showHover = true, hoverTileX = -1, hoverTileY = -1, hoverConflict = false, lastTileX = -1, lastTileY = -1;
...
c.onmousemove = function (e) {
	...
	if (hoverTileX !== lastTileX || hoverTileY !== lastTileY) {
		hoverConflict = false;
		if (currentItem) {
			iterTiles(function (tile) {
