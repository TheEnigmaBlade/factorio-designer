...
// Last modified: 5/28/2016, 5:01:55 AM
...
var drawWidth = c.width, drawHeight = c.height, tileWidth = 0, tileHeight = 0, tileSize = 32, tileHalfSize = tileSize / 2, offsetX = 0, offsetY = 0, minVisTileX = 0, minVisTileY = 0, maxVisTileX = 0, maxVisTileY = 0, showHover = true, hoverTileX = -1, hoverTileY = -1, hoverConflict = false, hoverConflictItem = null, lastTileX = -1, lastTileY = -1;
...
var bgColor = "rgb(39,166,204)", gridColor = "rgba(156,229,251, 0.5)", textColor = "#FFF";
var hoverColor = "rgba(0, 255, 150, 0.3)", hoverErrorColor = "rgba(255, 150, 150, 0.5)", hoverArrowColor = "#FFF", powerColor = "rgba(100, 120, 255, 0.7)";
var draw = $.throttle(15, function () {
	cg.beginPath();
...
function drawArrow(fromx, fromy, tox, toy) {
	var angle = Math.atan2(toy - fromy, tox - fromx), headAngle = Math.PI / 7, headLen = 10;
	cg.beginPath();
...
c.onmousemove = function (e) {
	...
	var tileChanged = hoverTileX !== lastTileX || hoverTileY !== lastTileY;
	if (tileChanged) {
		doDraw = true;
		hoverConflict = false;
		if (currentItem) {
...
function delTile(tileX, tileY) {
	...
	if (key) {
		...
		console.error("Can't delete tile: none found");
		return false;
	}
}
function clearTiles() {
