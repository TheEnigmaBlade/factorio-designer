...
// Last modified: 5/27/2016, 3:13:12 AM
...
gulp.task("copy:html", function () {
	...
	gulp.src(dirs.src + "/*.html").pipe(plugins().replace(/{{JQUERY_VERSION}}/g, libs.jquery.version)).pipe(plugins().replace(/{{VERSION}}/g, pkg.version)).pipe(plugins().foreach(function (stream, file) {
